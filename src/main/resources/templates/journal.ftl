...
<nav class="#ffffff white" role="navigation">
    <div class="nav-wrapper container">
        ...
        <ul id="nav-mobile" class="right hide-on-med-and-down">
            ...
            <li id="journalLi"><a class="#000000 black-text" href="${request.contextPath}/journal">日志</a></li>
...
<ul id="slide-out" class="side-nav ">
    ...
    <li><a class="waves-effect" href="${request.contextPath}/journal.html"><i
    ...
    <div class="row section">
        <div class="col s12">
            <ul class="tabs .tabs-fixed-width">
                ...
                <li class="tab col s3"><a target="_self" href="${request.contextPath}/index.html"><i class="material-icons ">label</i>返回首页</a>
                </li>
            </ul>
        </div>
    </div>
        ...
        <div class="col s9">
             <#list blogs as blog>
                ...
                <ul class="collection with-header">
                    <li class="collection-header"><h4><a href="" class="pink-text text-accent-1">${blog.title}</a></h4>
                    </li>
